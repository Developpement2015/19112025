        ...
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    <h4>Gestion des Grades</h4>
                    <h6 class="text-capitalize text-muted">Paramétrage Grades</h6>
                </div>
            </div>
            <ul class="table-top-head">
                <li>
                    <a href="{{ route('grades.pdf') }}" target="_blank" data-bs-toggle="tooltip" data-bs-placement="top"
                        title="Imprimer on PDF"><img src="/html/assets/img/icons/pdf.svg" alt="img"></a>
                </li>
                <li>
                    <a href="{{ route('grades.export') }}" data-bs-toggle="tooltip" data-bs-placement="top"
