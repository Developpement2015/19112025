<div class="edit-delete-action">
                ...
                <div class="page-wrapper-new p-0">
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body">
                            <form action="{{ route('niveau-categories-formation.update', $data->id) }}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <select name="type_categorie_formation_id"
                                                id="type_categorie_formation_id{{ $data->id }}"
                                                ...
                                                @foreach (\App\Models\TypeCategorieFormation::all() as $item)
                                                    <option @selected($item->id == $data->type_categorie_formation_id) value="{{ $item->id }}">
    ...
    <a class="me-0 btn btn-danger  p-2 mb-0" href="javascript:void(0);"
        onclick="confirmDelete({{ $data->id }}, '{{ route('niveau-categories-formation.delete', $data->id) }}', '{{ $data->nom }}', 'êtes-vous sûr de vouloir supprimer ce niveau de catégorie de formation?')">
