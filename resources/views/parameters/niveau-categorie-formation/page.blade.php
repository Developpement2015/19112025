<x-head titre="Gestion des niveaux de categories de formations" />
<x-header />
<x-sidebar />
        ...
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    <h4>Gestion des niveaux de categories de formations</h4>
                    <h6 class="text-capitalize text-muted">Paramétrage niveaux de categories de formations</h6>
                </div>
            </div>
            <ul class="table-top-head">
                <li>
                    <a href="{{ route('niveau-categories-formation.pdf') }}" target="_blank" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="Imprimer on PDF"><img src="/html/assets/img/icons/pdf.svg"
                            alt="img"></a>
                </li>
                <li>
                    <a href="{{ route('niveau-categories-formation.export') }}" data-bs-toggle="tooltip"
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table  " id="table" style="width:100%">
                        <thead>
                            <tr>
                                <th>Type de Catégorie de formation</th>
            ...
            <div class="page-wrapper-new p-0">
                <div class="content">
                    <div class="modal-header border-0 custom-modal-header">
                        <div class="page-title">
                            <h4>Ajouter une niveaux de categorie formation</h4>
                        </div>
                    ...
                    <div class="modal-body custom-modal-body">
                        <form action="{{ route('niveau-categories-formation.add') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label class="form-label" for="nom">Type de Catégorie de formation</label>
                                        <select name="type_categorie_formation_id" id="type_categorie_formation_id"
                                            class="form-select searchable-select" required>
                                            <option value="" disabled selected>Choisir un type de Catégorie de
                                                formation
                                            </option>
                                            @foreach (\App\Models\TypeCategorieFormation::all() as $item)
                                                <option value="{{ $item->id }}">
                                                    {{ $item->categorieFormation->nom .
                                                        ' - ' .
                                                        $item->categorieFormation->nom_arabe . ' ' .
                                                        $item->nom .
                                                        ' - ' .
                                                        $item->nom_arabe }}
                                                </option>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var table = new DataTable('#table', {
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('niveau-categories-formation.data') }}",
                data: function(d) {
