        ...
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    <h4>Gestion des cadres</h4>
                    <h6 class="text-capitalize text-muted">Paramétrage Cadres</h6>
                </div>
            </div>
            <ul class="table-top-head">
                <li>
                    <a href="{{ route('cadres.pdf') }}" target="_blank" data-bs-toggle="tooltip" data-bs-placement="top"
                        title="Imprimer on PDF"><img src="/html/assets/img/icons/pdf.svg" alt="img"></a>
                </li>
                <li>
                    <a href="{{ route('cadres.export') }}" data-bs-toggle="tooltip" data-bs-placement="top"
            ...
            <div class="page-wrapper-new p-0">
                <div class="content">
                    ...
                    <div class="modal-body custom-modal-body">
                        <form action="{{ route('cadres.add') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label class="form-label" for="nom">Catégorie Cadre</label>
                                        <select name="categorie_cadre_id" id="categories_cadres_id" class="form-select searchable-select"
                                            required>
                                            <option value="" disabled selected>Choisir une catégorie cadre
                                            </option>
                                            @foreach (\App\Models\CategorieCadre::all() as $item)
