    ...
    <div class="content">
        <div class="page-header">
            ...
            <ul class="table-top-head">
                <li>
                    <a href="{{route("type-de-mutation.pdf")}}" target="_blank"  data-bs-toggle="tooltip" data-bs-placement="top" title="Imprimer on PDF"><img
                            src="/html/assets/img/icons/pdf.svg" alt="img"></a>
                </li>
                <li>
                    <a href="{{route("type-de-mutation.export")}}" data-bs-toggle="tooltip" data-bs-placement="top" title="Exporter Fichier Excel"><img
            ...
            <div class="page-wrapper-new p-0">
                <div class="content">
                    ...
                    <div class="modal-body custom-modal-body">
                        <form action="{{ route('type-de-mutation.add') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var table = new DataTable('#table', {
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('type-de-mutation.data') }}",
                data: function (d) {
