<x-head titre="Arrondissements et Communes" />
<x-header />
<x-sidebar />
        ...
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    <h4>Gestion des Arrondissements et Communes</h4>
                    <h6 class="text-capitalize text-muted">Paramétrage / Arrondissements et Communes</h6>
                </div>
            </div>
            <ul class="table-top-head">
                <li>
                    <a href="{{route("arrondissements.pdf")}}" target="_blank"  data-bs-toggle="tooltip" data-bs-placement="top" title="Imprimer on PDF"><img
                            src="/html/assets/img/icons/pdf.svg" alt="img"></a>
                </li>
                <li>
                    <a href="{{route("arrondissements.export")}}" data-bs-toggle="tooltip" data-bs-placement="top" title="Exporter Fichier Excel"><img
            ...
            <div class="page-wrapper-new p-0">
                <div class="content">
                    <div class="modal-header border-0 custom-modal-header">
                        <div class="page-title">
                            <h4>Ajouter un Arrondissement/Commune</h4>
                        </div>
                    ...
                    <div class="modal-body custom-modal-body">
                        <form action="{{ route('arrondissements.add') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <select name="ville_id" id="ville_id"
                                            ...
                                            <option value="" disabled selected>Choisir une ville
                                            </option>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var table = new DataTable('#table', {
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('arrondissements.data') }}",
                data: function (d) {
                    d.nom = document.getElementById('nom').value || "{{ request()->get('nom') }}" || '';
                    d.nom_arabe = document.getElementById('nom_arabe').value || "{{ request()->get('nom_arabe') }}" || '';
                }
            },
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        if (type === 'display') {
                            return '<span class="badge badge-md bg-dark"> ' + data + '</span>';
                        }
                        return data;
                    }
                },
