        ...
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    ...
                    <h6 class="text-capitalize text-muted">Paramétrage Villes</h6>
                </div>
            </div>
            <ul class="table-top-head">
                <li>
                    <a href="{{ route('villes.pdf') }}" target="_blank" data-bs-toggle="tooltip" data-bs-placement="top"
                        title="Imprimer on PDF"><img src="/html/assets/img/icons/pdf.svg" alt="img"></a>
                </li>
                <li>
                    <a href="{{ route('villes.export') }}" data-bs-toggle="tooltip" data-bs-placement="top"
            ...
            <div class="page-wrapper-new p-0">
                <div class="content">
                    ...
                    <div class="modal-body custom-modal-body">
                        <form action="{{ route('villes.add') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3" >
                                        <label class="form-label" for="nom_arabe">Region</label>
                                        <select class="form-select" name="region_id">
                                            <option disabled selected="selected">Region</option>
                                            @foreach (\App\Models\Region::all() as $region)
                                                <option value="{{ $region->id }}">{{ $region->nom }} -
                                                    {{ $region->nom_arabe }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
