<x-head titre="Gestion des noms de formations sanitaires" />
<x-header />
<x-sidebar />
    ...
    <div class="content">
        <div class="page-header">
            ...
            <ul class="table-top-head">
                <li>
                    <a href="{{ route('nom-formation-sanitaire.pdf') }}" target="_blank" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="Imprimer on PDF"><img src="/html/assets/img/icons/pdf.svg"
                            alt="img"></a>
                </li>
                <li>
                    <a href="{{ route('nom-formation-sanitaire.export') }}" data-bs-toggle="tooltip"
            ...
            <div class="page-wrapper-new p-0">
                <div class="content">
                    ...
                    <div class="modal-body custom-modal-body modal-lg">
                        <form action="{{ route('nom-formation-sanitaire.add') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var table = new DataTable('#table', {
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('nom-formation-sanitaire.data') }}",
                data: function(d) {
