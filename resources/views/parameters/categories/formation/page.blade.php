<x-head titre="Categories Formation" />
<x-header />
<x-sidebar />
        ...
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    <h4>Gestion des catégorie formation</h4>
                    <h6 class="text-capitalize text-muted">Paramétrage Catégories formation</h6>
                </div>
            </div>
            <ul class="table-top-head">
                <li>
                    <a href="{{ route('categories-formation.pdf') }}" target="_blank" data-bs-toggle="tooltip" data-bs-placement="top"
                        title="Imprimer on PDF"><img src="/html/assets/img/icons/pdf.svg" alt="img"></a>
                </li>
                <li>
                    <a href="{{ route('categories-formation.export') }}" data-bs-toggle="tooltip" data-bs-placement="top"
            ...
            <div class="page-wrapper-new p-0">
                <div class="content">
                    <div class="modal-header border-0 custom-modal-header">
                        <div class="page-title">
                            <h4>Ajouter un catégorie de formation</h4>
                        </div>
                    ...
                    <div class="modal-body custom-modal-body">
                        <form action="{{ route('categories-formation.add') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var table = new DataTable('#table', {
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('categories-formation.data') }}",
                data: function(d) {
