    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="page-header">
                <div class="add-item d-flex">                    <div class="page-title">
                ...
                <ul class="table-top-head">
                    <li>
                        <a data-bs-toggle="tooltip" data-bs-placement="top" title="Pdf"><img src="/html/assets/img/icons/pdf.svg" alt="img"></a>
                    </li>
                    <li>
                        <a data-bs-toggle="tooltip" data-bs-placement="top" title="Excel"><img src="/html/assets/img/icons/excel.svg" alt="img"></a>
                    </li>
                    <li>
                        ...
                        <div class="search-path">
                            <div class="d-flex align-items-center">
                                <a class="btn btn-filter" id="filter_search">
                                    ...
                                    <span><img src="/html/assets/img/icons/closes.svg" alt="img"></span>
                                </a>
                ...
                <div class="page-wrapper-new p-0">
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body">
                            <form action="expense-category.html">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
