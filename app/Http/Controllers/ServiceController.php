...
class ServiceController  extends Controller
{
    ...
    {
        return view('parameters.services.page');
    }
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            return redirect()->back()->with('error', 'Une erreur s\'est produite lors de l\'ajout de la Service.');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->back()->with('success', 'Service mise à jour avec succès');
        } catch (\Exception $e) {
            return redirect()->back()->with('error', 'Une erreur s\'est produite lors de la mise à jour de la service.');
        }
    }
    ...
    public function data(Request $request)
    {
        ...
        return DataTables::of($query)
            ->addColumn('action', function ($data) {
                return view('parameters.services.action', compact('data'))->render();
            })
            ->rawColumns(['action'])
            ->toJson();
    }
    ...
    {
        $data = Service::all(['nom', 'nom_arabe']);
