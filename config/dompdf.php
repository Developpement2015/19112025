...
return [
    ...
    */
    ...
    'font_dir' => public_path('html/assets/img/pdf/'), // Path where your fonts are stored
    'font_cache' => storage_path('html/assets/img/pdf/'), // Path for caching

    'default_font' => 'Cairo', // Set the default font

    'fonts' => [
        'Cairo' => [
            'normal' => public_path('html/assets/img/pdf/Cairo-Regular.ttf'),
        ],
    ],
